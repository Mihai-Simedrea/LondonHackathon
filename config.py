...
# MetaDrive settings
METADRIVE_MAP = 7
METADRIVE_TRAFFIC_DENSITY = 0.15
METADRIVE_NUM_SCENARIOS = 100
METADRIVE_HORIZON = 1000
METADRIVE_NPC_SPEED = 50       # IDM cruising speed km/h (default was 30)
METADRIVE_NPC_MAX_SPEED = 120  # IDM max speed km/h (default was 100)
